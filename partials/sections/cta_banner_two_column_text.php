...
while (have_rows('cta_signup')): the_row();
		...
		<?php if ($has_image) : ?>
			...
			<?php while (have_rows('heading_text')): the_row();?>
				<div class="ctaBanner__text cell large-6">
					...
					<h2 class="heading3 medium-heading2 mt0">
